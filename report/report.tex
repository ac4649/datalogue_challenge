...
This was furhter confirmed by researching text classification and RNNs \cite{LeeDernoncourt}
...
forest classifier could be more apt at this task. \cite{XuGuoYeCheng}
...
this was thought to be worth a try.\cite{XuGuoYeCheng}
