...
The following models were created and tuned:
\begin{itemize}
\item dy-net built RNN Model using GloVe word embeddings
\item sklearn Random Forest Classifier using GloVe word embeddings
\end{itemize}
 % Dummy text
